...
multi_page(url="https://quotes.toscrape.com/page/",start_page=1,end_page=3,css_selector= ".quote span a")"""we are changing url from https://quotes.toscrape.com/page/1 to https://quotes.toscrape.com/page/ then set start_page=1 which will start
